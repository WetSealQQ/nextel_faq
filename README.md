...
> Лимит добавления номеров - 5000. Если в выбранных статусах номеров больше - добавляться только 5000.

![](/img/add_to_autodial_form_status.png "add_to_autodial_form_status")

- № 1 на рис.  - Заранее созданный автообзвон в nextel
- № 2 на рис.  - Статусы CRM с которых будут добавляться номера тел. в автообзвон
- № 3 на рис.  - Если выбрать отделы - номера с заказов будут добавлены в автообзвон только для выбранных отделов. Если не выбирать - номера добавляться со всех отделов для указанных статусов
- № 4 на рис.  - При включении - номера, которые уже присутствуют в обзвоне и уже обработаны, будут обработаны повторно (снова будут прозваниваться), при этом если обзвон происходит в текущий момент времени - эти номера будут прозваниваться первыми. При отключении - номера, которые уже присутствуют в обзвоне, будут просто игнорироваться
